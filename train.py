...
from dataset_test import FlareTest
...
def main():
    ...
    train_ds = Flare(
        "FlareRemovalPix2Pix\Flare_3029\Flare_3029",
        "FlareRemovalPix2Pix\Flare_3029\Wflare_3029",
    ...
    val_dataset = Flare(
        "FlareRemovalPix2Pix\Val_Flare\Flare",
        "FlareRemovalPix2Pix\Val_Flare\W_Flare",
        dataset_test.test_transform,
    )
